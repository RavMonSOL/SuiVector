    ...
    >
      ...
      <div className="py-4">
        <ul>
          ...
          <li>
            <Link href="/marketplace" className={`sidebar-item ${location === '/marketplace' ? 'active' : ''}`}>
          ...
          <li>
            <Link href="/create" className={`sidebar-item ${location === '/create' ? 'active' : ''}`}>
          ...
          <li>
            <Link href="/profile" className={`sidebar-item ${location === '/profile' ? 'active' : ''}`}>
          ...
          <li>
            <Link href="/groups" className={`sidebar-item ${location === '/groups' ? 'active' : ''}`}>
          ...
          <li>
            <Link href="/explore" className={`sidebar-item ${location === '/explore' ? 'active' : ''}`}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`${location === '/explore' ? 'text-primary' : 'text-muted-foreground'}`}><circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/></svg>
              <span className="font-medium">Explore</span>
            </Link>
          </li>
          <li>
            <Link href="/wallet" className={`sidebar-item ${location === '/wallet' ? 'active' : ''}`}>
